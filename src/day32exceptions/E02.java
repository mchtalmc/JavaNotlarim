...
public class E02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*******************");
        System.out.println(getElement(a, 5)); // BUYUKSE ILK ELAMANI VERIYOR
        System.out.println(getElement(a, -5));  // KUCUKSE NEGATIF YANI -->SON ELEMANI VERIYOR
    ...
    public static String getElement(String[] a, int numOfElement){
        ...
        try{
            ...
            // Negatifte olabilir index sayisindan buyukte olabilir
            if(numOfElement-1<0){
                result = a[0];
            }else{
                result = a[a.length-1];
